...
```python
from mindone.diffusers import ChronoEditTransformer3DModel
import mindspore as ms

transformer = ChronoEditTransformer3DModel.from_pretrained("kayte0342/chronoedit", subfolder="transformer", mindspore_dtype=ms.bfloat16)
```

::: mindone.diffusers.ChronoEditTransformer3DModel
