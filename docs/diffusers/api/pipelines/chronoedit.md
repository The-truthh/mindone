...
import numpy as np
from mindone.diffusers import AutoencoderKLWan, ChronoEditTransformer3DModel, ChronoEditPipeline
...
transformer = ChronoEditTransformer3DModel.from_pretrained(model_id, subfolder="transformer", mindspore_dtype=ms.bfloat16)
pipe = ChronoEditPipeline.from_pretrained(model_id, image_encoder=image_encoder, transformer=transformer, vae=vae, mindspore_dtype=ms.bfloat16)
...
output = pipe(
    ...
    num_temporal_reasoning_steps=20,
).frames[0]
...
import mindspore as ms
import numpy as np
from mindone.diffusers import AutoencoderKLWan, ChronoEditTransformer3DModel, ChronoEditPipeline, UniPCMultistepScheduler
from mindone.diffusers.utils import export_to_video, load_image
from mindone.transformers import CLIPVisionModel
from PIL import Image
...
::: mindone.diffusers.ChronoEditPipeline

::: mindone.diffusers.pipelines.chronoedit.pipeline_output.ChronoEditPipelineOutput
