...
|:-----:|:-----------------:|
| [`AIDC-AI/Ovis-Image-7B`](https://huggingface.co/AIDC-AI/Ovis-Image-7B) |   `ms.bfloat16`   |

Refer to [this](https://huggingface.co/collections/AIDC-AI/ovis-image) collection for more information.

::: mindone.diffusers.OvisImagePipeline

::: mindone.diffusers.pipelines.ovis_image.pipeline_output.OvisImagePipelineOutput
