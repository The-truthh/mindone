...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> # Available models: kayte0342/chronoedit
        ...
        ...     model_id, vae=vae, image_encoder=image_encoder, transformer=transformer, mindspore_dtype=ms.bfloat16
        ... )
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = mint.cat([latents, condition.to(latents.dtype)], dim=1).to(transformer_dtype)
        ...
        if not output_type == "latent":
            ...
            if enable_temporal_reasoning and latents.shape[2] > 2:
                ...
                video = mint.cat([video_reason, video_edit[:, :, 1:]], dim=2)
            else:
