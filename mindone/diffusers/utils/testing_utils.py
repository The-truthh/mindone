...
_run_weekly_tests = parse_flag_from_env("RUN_WEEKLY", default=False)
...
def weekly(test_case):
    ...
    """
    return pytest.mark.skipif(not _run_weekly_tests, reason="test is weekly")(test_case)
