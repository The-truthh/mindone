...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def _sigma_to_alpha_sigma_t(self, sigma: ms.Tensor) -> Tuple[ms.Tensor, ms.Tensor]:
        """
    ...
    def _convert_to_lu(self, in_lambdas: ms.Tensor, num_inference_steps: int) -> ms.Tensor:
        """
    ...
    def _init_step_index(self, timestep: Union[int, ms.Tensor]) -> None:
        """
    ...
    def step(
        ...
        Args:
            ...
            variance_noise (`ms.Tensor`, *optional*):
