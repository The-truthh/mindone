...
_import_structure = {
    ...
    "autoencoders.autoencoder_kl_hunyuanvideo15": ["AutoencoderKLHunyuanVideo15"],
    ...
    "transformers.transformer_chronoedit": ["ChronoEditTransformer3DModel"],
    ...
    "transformers.transformer_ovis_image": ["OvisImageTransformer2DModel"],
    ...
    "transformers.transformer_z_image": ["ZImageTransformer2DModel"],
