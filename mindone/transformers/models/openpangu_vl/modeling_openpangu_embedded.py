...
class PanguEmbeddedRMSNorm(ms.nn.Cell):
...
class PanguEmbeddedRotaryEmbedding(ms.nn.Cell):
...
class PanguEmbeddedMLP(ms.nn.Cell):
...
class PanguEmbeddedAttention(ms.nn.Cell):
