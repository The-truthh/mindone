...
class AyaVisionForConditionalGeneration(AyaVisionPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **lm_kwargs,
        ...
        >>> processor = AutoProcessor.from_pretrained("CohereLabs/aya-vision-8b", use_fast=True)
    ...
    def resize_token_embeddings(self, new_num_tokens: Optional[int] = None, pad_to_multiple_of=None) -> mint.nn.Embedding:
