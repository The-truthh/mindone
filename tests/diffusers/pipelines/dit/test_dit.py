...
@ddt
class DiTPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "transformer",
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.pipeline_dit.DiTPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.pipeline_dit.DiTPipeline")
