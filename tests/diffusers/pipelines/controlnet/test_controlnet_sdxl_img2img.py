...
class ControlNetPipelineSDXLImg2ImgIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_stable_diffusion_xl_controlnet_img2img(self, mode, dtype):
        ...
        depth_estimator_cls = get_module("mindone.transformers.models.dpt.feature_extraction_dpt.DPTForDepthEstimation")
        depth_estimator = depth_estimator_cls.from_pretrained("Intel/dpt-hybrid-midas")
        feature_extractor_cls = get_module("transformers.models.dpt.modeling_dpt.DPTFeatureExtractor")
        feature_extractor = feature_extractor_cls.from_pretrained("Intel/dpt-hybrid-midas")
