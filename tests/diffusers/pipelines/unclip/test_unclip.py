...
class UnCLIPPipelineFastTests(unittest.TestCase):
    ...
    def test_unclip(self, mode, dtype):
        ...
        sys.modules[ms_pipe.decoder_scheduler.__module__].randn_tensor = randn_tensor
        sys.modules[ms_pipe.super_res_scheduler.__module__].randn_tensor = randn_tensor
