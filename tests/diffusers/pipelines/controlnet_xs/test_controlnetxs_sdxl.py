...
@ddt
class StableDiffusionXLControlNetXSPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.pipeline_controlnet_xs.StableDiffusionXLControlNetXSPipeline")
        ms_pipe_cls = get_module(
            "mindone.diffusers.pipelines.pipeline_controlnet_xs.StableDiffusionXLControlNetXSPipeline"
        )
