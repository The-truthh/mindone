...
from mindone.diffusers.utils.testing_utils import load_downloaded_image_from_hf_hub, load_downloaded_numpy_from_hf_hub, export_to_gif
...
class AnimateDiffPipelineSDXLIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        vae = vae_cls.from_pretrained(
            "madebyollin/sdxl-vae-fp16-fix", mindspore_dtype=ms_dtype
        )
