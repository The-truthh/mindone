...
class AdapterTests:
    ...
    def get_dummy_components(self, adapter_type, time_cond_proj_dim=None):
        ...
        if adapter_type == "full_adapter" or adapter_type == "light_adapter":
            ...
            raise ValueError(
                f"Unknown adapter type: {adapter_type}, must be 'full_adapter' or 'light_adapter'"
            )
...
@ddt
class StableDiffusionFullAdapterPipelineFastTests(AdapterTests, unittest.TestCase):
...
@ddt
class StableDiffusionLightAdapterPipelineFastTests(AdapterTests, unittest.TestCase):
    def get_dummy_components(self, time_cond_proj_dim=None):
