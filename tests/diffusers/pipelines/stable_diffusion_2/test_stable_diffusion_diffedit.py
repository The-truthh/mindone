...
@ddt
class StableDiffusionDiffEditPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_mask(self, mode, dtype):
        ...
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.stable_diffusion_diffedit.StableDiffusionDiffEditPipeline")
