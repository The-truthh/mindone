...
# TODO: torch.flot16 requires CUDA
test_cases = [
...
@ddt
class StableCascadeCombinedPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "prior_prior",
    ...
    def test_stable_cascade(self, mode, dtype):
        ...
        sys.modules[ms_pipe.prior_pipe.__module__].randn_tensor = randn_tensor
        sys.modules[ms_pipe.decoder_pipe.__module__].randn_tensor = randn_tensor
        sys.modules[ms_pipe.scheduler.__module__].randn_tensor = randn_tensor
        sys.modules[ms_pipe.prior_scheduler.__module__].randn_tensor = randn_tensor
