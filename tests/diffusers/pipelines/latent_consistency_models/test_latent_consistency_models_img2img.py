...
@ddt
class LatentConsistencyModelImg2ImgPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_lcm_multistep(self, mode, dtype):
        ...
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.latent_consistency_models.LatentConsistencyModelImg2ImgPipeline")
