...
@ddt
class StableDiffusionXLInstructPix2PixPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_stable_diffusion_xl_pix2pix_euler(self, mode, dtype):
        ...
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.stable_diffusion_xl.StableDiffusionXLInstructPix2PixPipeline")
