...
@ddt
class KandinskyV22PriorEmb2EmbPipelineFastTests(unittest.TestCase):
    pipeline_config = [
        [
            "prior",
    ...
    def get_dummy_components(self):
        ...
        ms_components["prior"].clip_std = ms.Parameter(ms.ops.ones(ms_components["prior"].clip_std.shape))
