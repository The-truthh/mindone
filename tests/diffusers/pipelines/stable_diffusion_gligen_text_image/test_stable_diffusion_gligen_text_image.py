...
@ddt
class GligenTextImagePipelineFastTests(unittest.TestCase,):
    pipeline_config = [
        [
            "unet",
    ...
    def test_stable_diffusion_gligen_text_image_default_case(self, mode, dtype):
        ...
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.stable_diffusion_gligen.StableDiffusionGLIGENTextImagePipeline")
