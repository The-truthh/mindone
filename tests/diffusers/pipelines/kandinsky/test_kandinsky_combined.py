...
@ddt
class KandinskyPipelineCombinedFastTests(unittest.TestCase):
...
@ddt
class KandinskyPipelineImg2ImgCombinedFastTests(unittest.TestCase):
    def get_dummy_components(self):
...
class KandinskyPipelineInpaintCombinedFastTests(unittest.TestCase):
    def get_dummy_components(self):
