...
@pytest.mark.parametrize(
    "encoder_name,pt_encoder,ms_encoder,decoder_name,pt_decoder,ms_decoder,name,pt_module,ms_module,init_args,init_kwargs,inputs_args,inputs_kwargs,outputs_map,dtype,mode",
    [
        case
        + [
            dtype,
...
def test_named_modules(
    ...
    pt_encoder, ms_encoder, pt_dtype, ms_dtype = get_modules(pt_encoder, ms_encoder, dtype, *init_args, **encoder_kwargs)
